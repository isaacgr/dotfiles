...
-- NOTE: Dependencies that were separate lazy.nvim plugins are now separate vim.pack specs.
-- Make sure conform, mason, mason-lspconfig, nvim-cmp, cmp-nvim-lsp,
-- LuaSnip, cmp_luasnip, and fidget are all loaded before this plugin's setup runs.
...
return {
    ...
    -- nvim-lspconfig (main LSP config - setup runs after dependencies are loaded)
    {
