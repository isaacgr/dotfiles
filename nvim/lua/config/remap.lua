...
vim.keymap.set("n", "<leader>d", "\"_d", { desc = "Delete (no register)" })
vim.keymap.set("v", "<leader>d", "\"_d", { desc = "Delete (no register)" })
...
vim.keymap.set("n", "<leader>J", ":%!python3 -m json.tool<CR>", { desc = "Format JSON (python)" })
...
local opts = { noremap = true, silent = true, desc = "Disabled (use hjkl)" }
